...
class ArgonSceneExporterModel(object):
    ...
    def exportViewJson(self):
        ...
        viewData = {}
        viewData['farPlane'] = sceneviewer._far_clipping_plane
        viewData['nearPlane'] = sceneviewer._near_clipping_plane
        viewData['eyePosition'] = sceneviewer._eye_position
        viewData['targetPosition'] = sceneviewer._lookat_position
        viewData['upVector'] = sceneviewer._up_vector
